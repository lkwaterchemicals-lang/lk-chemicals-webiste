...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "LK Chemicals Pvt. Ltd. — Hyderabad-based manufacturer of RO, boiler, cooling tower and descaling chemicals, resins and industrial water treatment services since 2009." },
      ...
      { property: "og:description", content: "LK Chemicals Pvt. Ltd. — Hyderabad-based manufacturer of RO, boiler, cooling tower and descaling chemicals, resins and industrial water treatment services since 2009." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0a0f1e" },
      { name: "twitter:title", content: "LK Chemicals — Industrial Water Treatment Chemicals, Hyderabad" },
      { name: "twitter:description", content: "LK Chemicals Pvt. Ltd. — Hyderabad-based manufacturer of RO, boiler, cooling tower and descaling chemicals, resins and industrial water treatment services since 2009." },
